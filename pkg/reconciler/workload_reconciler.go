...
type WorkloadReconciler interface {
	Reconciler(ctx context.Context, rbg *workloadsv1alpha1.RoleBasedGroup, role *workloadsv1alpha1.RoleSpec, currentRevision, updatedRevision *appsv1.ControllerRevision) error
	ConstructRoleStatus(
